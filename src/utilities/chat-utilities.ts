...
export const generateChatPrompt = (messages: Messages, language: string): CodexPrompt => {
    const desc = `You are an expert programmer. You are the assistant of a developer. You answer their questions, give them code snippets and useful tips and tricks. The developer is currently writing ${language} code\n`;
    let prompt = desc;
